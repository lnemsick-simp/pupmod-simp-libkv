module DataHelper
  ...
  # @returns Hash of test data for different data types. The hash assumes the
  # metadata associated with each value is { 'foo'=>'bar', 'baz'=>42 }.
  #
  #   * key = description of the data type
  #   * value = Hash
  #     * :value              = Required. Value set with libkv::put()
  #     * :serialized_value   = Required. String value persisted in the store.
  #                             It is generated by the libkv adapter from :value.
  #     * :deserialized_value = Optional. Value restored by the libkv adapter
  #                             from the stored value.  This is a problem that
  #                             could be fixed, but it is unclear if it is a
  #                             valid use case yet.
  #     * :skip               = Optional. Known problem with serialization/
  #                             deserialization that requires significant
  #                             rework.  May be addressed later.
  def data_info
